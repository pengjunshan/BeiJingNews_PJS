...
//            imageLoader.displayImage(url, viewHolder.iv_icon, options, animateFirstListener);
           ...
           /* Glide.with(context).load(url)
                    ...
                    .placeholder(R.drawable.pic_item_list_default)//加载过程中的图片
                    .error(R.drawable.pic_item_list_default)//加载失败的时候显示的图片
